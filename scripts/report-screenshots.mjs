...
await homeMobile.goto('http://127.0.0.1:4176/');
...
await homeDesktop.goto('http://127.0.0.1:4176/');
...
await empty.goto(`http://127.0.0.1:4176/trips?from=place%3A00000000-0000-4000-b000-0000000003001&to=place%3A00000000-0000-4000-b000-0000000003031&date=${new Date().toISOString().slice(0, 10)}`);
